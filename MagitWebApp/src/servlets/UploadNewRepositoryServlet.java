...
public class UploadNewRepositoryServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        } catch (BranchIsAllReadyOnWCException | OpenChangesException | CommitException | CheckoutToRemoteBranchException | RepositoryAllreadyExistException | ParseException | BranchDoesNotExistException e) {
